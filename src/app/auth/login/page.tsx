    ...
    <div className="min-h-screen bg-dark-950 flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-md relative z-10">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold font-display text-white mb-2">Heureux de vous revoir</h1>
          <p className="text-dark-300">Connectez-vous pour accéder à vos événements</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <Link href="/auth/forgot-password" className="text-sm text-neon-green hover:text-neon-green-dim transition-colors">
                  Mot de passe oublié ?
                </Link>
              </div>
              <div className="relative">
            ...
            <div className="flex items-center">
              ...
              />
              <label htmlFor="remember-me" className="ml-3 text-sm text-dark-300">Se souvenir de moi</label>
            </div>
        ...
        <p className="mt-6 text-center text-dark-400">
          ...
          <Link href="/auth/signup" className="text-neon-green hover:text-neon-green-dim transition-colors font-medium">
            Créer un compte
          </Link>
        </p>
      </div>
